...
namespace TechNews.Models
{
    public class DataContext : DbContext
    {
        ...
        public void SeedData()
        {
            ...
            {
                AboutUs.AddRange(
                    new AboutUs { Id = 1, WebName = "TechNews", AdminName = "Quản trị viên", AdminAvatar = "https://i.pinimg.com/736x/cc/52/3f/cc523f7dc794dfed54aac0973348e541.jpg", Email = "admin@technews.com", Number = "0989123456", Address = "Vinh University", Content = "We are TechNews", Image = "/uploads/hoa-tua-may-troi.jpeg/", Facebook = "facebook.com", Instagram = "instagram.com", Linkedin = "linkedin.com", Twitter = "twitter.com", Youtube = "youtube.com" }
                );
                ...
                AdminMenu.AddRange(
                    ...
                    new AdminMenu { MenuId = 3, MenuName = "Quản lý bài viết", RoleId = 2, ControllerName = "Post", ActionName = "Index", Level = 2, ParentId = 2, MenuOrder = 1, Target = "", Icon = "bi bi-menu-button-wide", IsActive = true },
                    new AdminMenu { MenuId = 4, MenuName = "Quản lý danh mục", RoleId = 3, ControllerName = "Menu", ActionName = "Index", Level = 2, ParentId = 2, MenuOrder = 2, Target = "", Icon = "bi bi-menu-button-wide", IsActive = true },
                    new AdminMenu { MenuId = 5, MenuName = "Quản lý tài khoản", RoleId = 3, ControllerName = "Account", ActionName = "Index", Level = 2, ParentId = 2, MenuOrder = 3, Target = "", Icon = "bi bi-menu-button-wide", IsActive = true },
